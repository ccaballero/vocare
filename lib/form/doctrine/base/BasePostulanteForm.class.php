...
abstract class BasePostulanteForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'estado'              => new sfWidgetFormChoice(array('choices' => array('sin confirmación' => 'sin confirmación', 'pendiente' => 'pendiente', 'inscrito' => 'inscrito', 'inhabilitado' => 'inhabilitado', 'habilitado' => 'habilitado'))),
    ...
    $this->setValidators(array(
      ...
      'estado'              => new sfValidatorChoice(array('choices' => array(0 => 'sin confirmación', 1 => 'pendiente', 2 => 'inscrito', 3 => 'inhabilitado', 4 => 'habilitado'), 'required' => false)),
